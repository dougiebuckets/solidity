...
// SyntaxError: (247-263): Use of the "var" keyword is disallowed. Use explicit declaration `string t = ...' instead.
...
// SyntaxError: (336-360): Use of the "var" keyword is disallowed. Use explicit declaration `(uint8 a, string b) = ...' instead.
